...
walk_turn_time      = 6;	    // 6
initial_dash_time   = 11;		// 8    -  16
initial_dash_speed  = 4;		// 4    -  9
dash_speed          = 6;		// 5    -  9
dash_turn_time      = 10;		// 8    -  20
dash_turn_accel     = 1.5;		// 0.1  -  2
dash_stop_time      = 9;		// 4    -  6
...
// Jumps
jump_start_time     = 8;		// 5                this stat is automatically decreased by 1 after init.gml (dan moment), so its "real value" is 4. if you change this during a match, 4 is the value you should reset it to
