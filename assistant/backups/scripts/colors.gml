...
// Blue
set_color_profile_slot( 1, 0, 0, 119, 255 ); //Fur
set_color_profile_slot( 1, 1, 138, 218, 255 ); //Skin
set_color_profile_slot( 1, 2, 255, 210, 143 ); //Wood

// Lava
set_color_profile_slot( 2, 0, 255, 38, 0 ); //Fur
set_color_profile_slot( 2, 1, 191, 109, 109 ); //Skin
set_color_profile_slot( 2, 2, 41, 34, 0 ); //Wood

// Fiddle
set_color_profile_slot( 3, 0, 2, 122, 0 ); //Fur
set_color_profile_slot( 3, 1, 30, 255, 0 ); //Skin
set_color_profile_slot( 3, 2, 0, 173, 0 ); //Wood

// Virtual Boy
set_color_profile_slot( 4, 0, 179, 0, 0 ); //Fur
set_color_profile_slot( 4, 1, 255, 94, 94 ); //Skin
set_color_profile_slot( 4, 2, 125, 0, 0 ); //Wood

// Monochrome
set_color_profile_slot( 5, 0, 105, 105, 105 ); //Fur
set_color_profile_slot( 5, 1, 230, 230, 230 ); //Skin
set_color_profile_slot( 5, 2, 28, 28, 28 ); //Wood


/* This is a comment used by that one RoA colors.gml generator tool to store palette data. You can safely keep it in your colors.gml if you plan to re-use the tool later, or safely remove it if you don't.
=== BEGIN JSON PALETTE ===
{"formatversion":1,"data":[{"name":"Fur","colors":[{"r":51,"g":102,"b":52,"main":true},{"r":32,"g":64,"b":33},{"r":88,"g":147,"b":108}]},{"name":"Skin","colors":[{"r":242,"g":247,"b":238},{"r":178,"g":205,"b":152,"main":true}]},{"name":"Wood","colors":[{"r":99,"g":70,"b":61},{"r":187,"g":155,"b":143},{"r":136,"g":104,"b":93,"main":true}]}]}
=== END JSON PALETTE ===
*/
